...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/Code/CPU/CPU.cache/wt [current_project]
  set_property parent.project_path D:/Code/CPU/CPU.xpr [current_project]
  set_property ip_repo_paths d:/Code/CPU/CPU.cache/ip [current_project]
  set_property ip_output_repo d:/Code/CPU/CPU.cache/ip [current_project]
  add_files -quiet D:/Code/CPU/CPU.runs/synth_1/Controller.dcp
...
set rc [catch {
  ...
  catch { report_drc -file Controller_drc_routed.rpt -pb Controller_drc_routed.pb }
  ...
  catch { report_power -file Controller_power_routed.rpt -pb Controller_power_summary_routed.pb }
